    ...
    <div style={{
      ...
      <div className="animate-fadeUp" style={{ width: '100%', maxWidth: 420, position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          <div style={{ width: 60, height: 60, background: 'var(--accent-dim)', border: '1.5px solid var(--accent)', borderRadius: 16, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 28, color: 'var(--accent)', margin: '0 auto 16px' }}>
            <MdSecurity />
          </div>
          <h1 style={{ fontSize: 28, color: 'var(--text)' }}>VisitorPass</h1>
          <p style={{ color: 'var(--text-muted)', marginTop: 4, fontSize: 14 }}>Visitor Management System</p>
        </div>

        <div className="card">
          <h2 style={{ fontSize: 18, marginBottom: 4 }}>Sign in</h2>
          <p style={{ color: 'var(--text-muted)', fontSize: 13, marginBottom: 24 }}>Enter your credentials to continue</p>
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input type="email" placeholder="you@example.com" value={form.email} onChange={e => setForm(p => ({ ...p, email: e.target.value }))} style={{ paddingLeft: 36 }} required />
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input type="password" placeholder="••••••••" value={form.password} onChange={e => setForm(p => ({ ...p, password: e.target.value }))} style={{ paddingLeft: 36 }} required />
              </div>
            </div>

            <button type="submit" className="btn btn-primary" style={{ width: '100%', justifyContent: 'center', marginTop: 8, height: 44 }} disabled={loading}>
